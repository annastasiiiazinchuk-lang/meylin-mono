...
export const env = {
  ...
  googleAdsConversionActionId: process.env.GOOGLE_ADS_CONVERSION_ACTION_ID || '',
  googleAdsConversionActionResourceName: process.env.GOOGLE_ADS_CONVERSION_ACTION_RESOURCE_NAME || '',
